-- Top Dragon TMS — Etap 3L.32
-- Naprawa / samowystarczalne odtworzenie schematu workflow z 3L.31.
-- Plik można uruchomić także wtedy, gdy 023 była wykonana częściowo lub wcześniej poprawnie.
-- Na końcu wymuszamy przeładowanie cache schematu PostgREST.
...
-- Supabase/PostgREST: odśwież cache nowych tabel i RPC bez oczekiwania na automatyczną propagację.
